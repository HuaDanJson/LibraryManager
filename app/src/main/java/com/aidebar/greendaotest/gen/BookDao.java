...
public class BookDao extends AbstractDao<Book, Long> {
    ...
    public static class Properties {
        ...
        public final static Property BorrowerName = new Property(10, String.class, "BorrowerName", false, "BORROWER_NAME");
        public final static Property RemainderBooks = new Property(11, int.class, "remainderBooks", false, "REMAINDER_BOOKS");
    }
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"BOOK\" (" + //
                ...
                "\"BORROWER_NAME\" TEXT," + // 10: BorrowerName
                "\"REMAINDER_BOOKS\" INTEGER NOT NULL );"); // 11: remainderBooks
    }
    ...
    protected final void bindValues(DatabaseStatement stmt, Book entity) {
        ...
        if (BorrowerName != null) {
            stmt.bindString(11, BorrowerName);
        }
        stmt.bindLong(12, entity.getRemainderBooks());
    }
    ...
    public Book readEntity(Cursor cursor, int offset) {
        Book entity = new Book( //
            ...
            cursor.isNull(offset + 10) ? null : cursor.getString(offset + 10), // BorrowerName
            cursor.getInt(offset + 11) // remainderBooks
        );
        return entity;
    }
    ...
    public void readEntity(Cursor cursor, Book entity, int offset) {
        ...
        entity.setBorrowerName(cursor.isNull(offset + 10) ? null : cursor.getString(offset + 10));
        entity.setRemainderBooks(cursor.getInt(offset + 11));
     }
